...
!function (e, t) {
	...
	return function (e) {
		function t(a) {
			...
			var l = n[a] = {exports: {}, id: a, loaded: !1};
			return e[a].call(l.exports, l, l.exports, t), l.loaded = !0, l.exports
		}
		...
		r.keys().forEach(function (e) {
			var t = e.replace("./", ""), n = "mwl/" + t, a = t.replace(".html", "");
			i[a] = {cacheTemplateName: n, template: r(e)}
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlCalendarCtrl", ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", "calendarHelper", function (e, t, n, l, i, r, d, s) {
			function o(e) {
			...
			function c() {
				d[v.view] && a.isDefined(l.viewTitle) && (v.viewTitle = d[v.view](v.viewDate)), v.events = v.events.filter(o).map(function (e, t) {
					return Object.defineProperty(e, "$id", {enumerable: !1, configurable: !0, value: t}), e
				});
				var t = r(v.viewDate), i = !0;
			...
			v.events = v.events || [], v.changeView = function (e, t) {
				...
				var t = r(e).toDate(), n = {year: "month", month: "day", week: "day"};
		...
		a.module("mwl.calendar").controller("MwlCalendarDayCtrl", ["$scope", "$sce", "moment", "calendarHelper", function (e, t, n, a) {
			var l = this;
			l.$sce = t, e.$on("calendar.refreshView", function () {
				...
				var a = t * l.dayViewSplit, i = n(e.startsAt).add(a, "minutes"), r = n(e.endsAt).add(a, "minutes");
				...
				var a = t * l.dayViewSplit;
				e.tempStartsAt = n(e.startsAt).add(a, "minutes").toDate()
			}, l.eventResizeComplete = function (e, t, a) {
				var i = a * l.dayViewSplit, r = n(e.startsAt), d = n(e.endsAt);
				"start" === t ? r.add(i, "minutes") : d.add(i, "minutes"), delete e.tempStartsAt, l.onEventTimesChanged({
					calendarEvent: e,
					calendarNewEventStart: r.toDate(),
					calendarNewEventEnd: d.toDate()
				})
			}, l.eventResized = function (e, t, a) {
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlCalendarHourListCtrl", ["$scope", "$attrs", "moment", "calendarConfig", "calendarHelper", function (e, t, n, a, l) {
			function i() {
				r = n(s.dayViewStart || "00:00", "HH:mm"), d = n(s.dayViewEnd || "23:00", "HH:mm"), s.dayViewSplit = parseInt(s.dayViewSplit), s.hours = [];
				var e = n(s.viewDate).clone();
				t.dayWidth && (e = e.startOf("week")), e.hours(r.hours()).minutes(r.minutes()).seconds(r.seconds());
				for (var i = 0; i <= d.diff(r, "hours"); i++)s.hours.push({
			...
			e.$on("calendar.refreshView", function () {
				...
				var a = n(t), i = l.adjustEndDateFromStartDiff(e.startsAt, a, e.endsAt);
			...
			}, s.onDragSelectStart = function (e) {
				s.dateRangeSelect = {startDate: e, endDate: e}
			}, s.onDragSelectMove = function (e) {
				s.dateRangeSelect && (s.dateRangeSelect.endDate = e)
			}, s.onDragSelectEnd = function (e) {
				s.dateRangeSelect.endDate = e, s.dateRangeSelect.endDate > s.dateRangeSelect.startDate && s.onDateRangeSelect({
					calendarRangeStartDate: s.dateRangeSelect.startDate,
					calendarRangeEndDate: s.dateRangeSelect.endDate
				}), delete s.dateRangeSelect
			}
		...
		a.module("mwl.calendar").controller("MwlCalendarMonthCtrl", ["$scope", "moment", "calendarHelper", "calendarConfig", function (e, t, n, a) {
			var l = this;
			l.calendarConfig = a, l.openRowIndex = null, e.$on("calendar.refreshView", function () {
				l.weekDays = n.getWeekDayNames(), l.view = n.getMonthView(l.events, l.viewDate, l.cellModifier);
				var e = Math.floor(l.view.length / 7);
				l.monthOffsets = [];
				for (var a = 0; e > a; a++)l.monthOffsets.push(7 * a);
				l.cellIsOpen && null === l.openRowIndex && (l.openDayIndex = null, l.view.forEach(function (e) {
					e.inMonth && t(l.viewDate).startOf("day").isSame(e.date) && l.dayClicked(e, !0)
				}))
			}), l.dayClicked = function (e, t, n) {
				if (t || (l.onTimespanClick({
					...
					a === l.openDayIndex ? (l.openDayIndex = null, l.cellIsOpen = !1) : (l.openDayIndex = a, l.openRowIndex = Math.floor(a / 7), l.cellIsOpen = !0)
				}
			}, l.highlightEvent = function (e, t) {
			...
			}, l.handleEventDrop = function (e, a, i) {
				var r = t(e.startsAt).date(t(a).date()).month(t(a).month()).year(t(a).year()), d = n.adjustEndDateFromStartDiff(e.startsAt, r, e.endsAt);
		...
		a.module("mwl.calendar").controller("MwlCalendarSlideBoxCtrl", ["$sce", "$scope", "$timeout", "calendarConfig", function (e, t, n, a) {
			var l = this;
			l.$sce = e, l.calendarConfig = a, l.isCollapsed = !0, t.$watch("vm.isOpen", function (e) {
				n(function () {
					l.isCollapsed = !e
				})
			})
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlCalendarWeekCtrl", ["$scope", "$sce", "moment", "calendarHelper", "calendarConfig", function (e, t, n, a, l) {
			var i = this;
			i.showTimes = l.showTimesOnWeekView, i.$sce = t, e.$on("calendar.refreshView", function () {
				...
				var l = n(e.startsAt).add(t, "days"), r = n(e.endsAt).add(t, "days");
				if (a) {
					var d = a * i.dayViewSplit;
					l = l.add(d, "minutes"), r = r.add(d, "minutes")
				}
				...
				var l = n(e.startsAt), r = n(e.endsAt);
				"start" === t ? l.add(a, "days") : r.add(a, "days"), i.onEventTimesChanged({
					calendarEvent: e,
					calendarNewEventStart: l.toDate(),
		...
		a.module("mwl.calendar").controller("MwlCalendarYearCtrl", ["$scope", "moment", "calendarHelper", function (e, t, n) {
			...
			a.openMonthIndex = null, e.$on("calendar.refreshView", function () {
				...
				if (t || (a.onTimespanClick({
					...
					a.openRowIndex = null;
					var l = a.view.indexOf(e);
					l === a.openMonthIndex ? (a.openMonthIndex = null, a.cellIsOpen = !1) : (a.openMonthIndex = l, a.openRowIndex = Math.floor(l / 4), a.cellIsOpen = !0)
				}
			}, a.handleEventDrop = function (e, l) {
				var i = t(e.startsAt).month(t(l).month()).year(t(l).year()), r = n.adjustEndDateFromStartDiff(e.startsAt, i, e.endsAt);
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlDateModifierCtrl", ["$element", "$attrs", "$scope", "moment", function (e, t, n, l) {
			function i() {
				a.isDefined(t.setToToday) ? r.date = new Date : a.isDefined(t.increment) ? r.date = l(r.date).add(1, r.increment).toDate() : a.isDefined(t.decrement) && (r.date = l(r.date).subtract(1, r.decrement).toDate()), n.$apply()
			}
		...
		a.module("mwl.calendar").controller("MwlDragSelectCtrl", ["$scope", "$element", "$parse", "$attrs", function (e, t, n, a) {
			...
			function i() {
				t.on("mousedown", d), t.on("mousemove", s), t.on("mouseup", o)
			}

			function r() {
				t.off("mousedown", d), t.off("mousemove", s), t.off("mouseup", o)
			}

			var d = l(a.onDragSelectStart), s = l(a.onDragSelectMove), o = l(a.onDragSelectEnd);
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlDraggableCtrl", ["$element", "$scope", "$window", "$parse", "$attrs", "$timeout", "interact", function (e, t, n, l, i, r, d) {
			function s(e, t) {
			...
			if (d) {
				var o, c;
				i.snapGrid && (c = l(i.snapGrid)(t), o = {targets: [d.createSnapGrid(c)]}), d(e[0]).draggable({
					snap: o,
					onstart: function (e) {
						a.element(e.target).addClass("dragging-active"), e.target.dropData = l(i.dropData)(t), e.target.style.pointerEvents = "none", i.onDragStart && (l(i.onDragStart)(t), t.$apply())
					},
					onmove: function (e) {
						var r = a.element(e.target), d = (parseFloat(r.attr("data-x")) || 0) + (e.dx || 0), o = (parseFloat(r.attr("data-y")) || 0) + (e.dy || 0);
						switch (l(i.axis)(t)) {
							case"x":
								o = 0;
								break;
						...
						"static" === n.getComputedStyle(r[0]).position && r.css("position", "relative"), s(r, "translate(" + d + "px, " + o + "px)").css("z-index", 50).attr("data-x", d).attr("data-y", o), i.onDrag && (l(i.onDrag)(t, {
							x: d,
							y: o
						}), t.$apply())
					},
					onend: function (e) {
						var n = a.element(e.target), d = n.attr("data-x"), o = n.attr("data-y");
						e.target.style.pointerEvents = "auto", i.onDragEnd && (l(i.onDragEnd)(t, {
							x: d,
							y: o
						}), t.$apply()), r(function () {
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlDroppableCtrl", ["$element", "$scope", "$parse", "$attrs", "interact", function (e, t, n, l, i) {
			if (i) {
				var r = l.dropActiveClass || "drop-active";
				i(e[0]).dropzone({
					ondragenter: function (e) {
						...
						e.relatedTarget.dropData && (n(l.onDrop)(t, {dropData: e.relatedTarget.dropData}), t.$apply())
					}
				}), t.$on("$destroy", function () {
					i(e[0]).unset()
				})
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlElementDimensionsCtrl", ["$element", "$scope", "$parse", "$attrs", "$window", function (e, t, n, l, i) {
			function r() {
				n(l.mwlElementDimensions).assign(t, {
			...
			var d = a.element(i);
			d.bind("resize", r), r(), t.$on("$destroy", function () {
				d.unbind("resize", r)
			})
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").controller("MwlResizableCtrl", ["$element", "$scope", "$parse", "$attrs", "$timeout", "interact", function (e, t, n, l, i, r) {
			function d(e, t) {
				var n = {};
			...
			if (r) {
				var s, o;
				l.snapGrid && (o = n(l.snapGrid)(t), s = {targets: [r.createSnapGrid(o)]});
				var c, v = {}, m = {};
				r(e[0]).resizable({
					edges: n(l.resizeEdges)(t), snap: s, onstart: function (e) {
						c = "end";
						...
						if (e.rect.width > 0 && e.rect.height > 0) {
							var i = a.element(e.target), r = parseFloat(i.data("x") || 0), s = parseFloat(i.data("y") || 0);
							i.css({
								width: e.rect.width + "px",
								height: e.rect.height + "px"
							}), r += e.deltaRect.left, s += e.deltaRect.top, i.css("transform", "translate(" + r + "px," + s + "px)"), i.data("x", r), i.data("y", s), (0 !== e.deltaRect.left || 0 !== e.deltaRect.top) && (c = "start"), l.onResize && (n(l.onResize)(t, d(c, i)), t.$apply())
						}
					}, onend: function (e) {
						var r = a.element(e.target), s = d(c, r);
						i(function () {
							r.data("x", null).data("y", null).css({transform: "", width: m.width, height: m.height})
						}), l.onResizeEnd && (n(l.onResizeEnd)(t, s), t.$apply())
					}
				}), t.$watch(l.mwlResizable, function (t) {
					r(e[0]).resizable({enabled: t})
				}), t.$on("$destroy", function () {
					r(e[0]).unset()
				})
			}
		...
		a.module("mwl.calendar").filter("calendarDate", ["calendarHelper", "calendarConfig", function (e, t) {
			function n(n, a, l) {
				return l === !0 && (a = t.dateFormats[a]), e.formatDate(n, a)
			}
		...
		"use strict";
		var a = n(1);
		a.module("mwl.calendar").factory("calendarHelper", ["$q", "$templateRequest", "dateFilter", "moment", "calendarConfig", function (e, t, n, a, l) {
			function i(e, t) {
				if ("angular" === l.dateFormatter)return n(a(e).toDate(), t);
				if ("moment" === l.dateFormatter)return a(e).format(t);
			...
			function d(e, t, n) {
				var l = a(e.start), i = a(e.end), d = a(n);
				if (t) {
					switch (t) {
						case"year":
							l.set({year: d.year()});
			...
			function s(e, t, n) {
				t = a(t), n = a(n);
				var l = d({start: e.startsAt, end: e.endsAt || e.startsAt}, e.recursOn, t), i = l.start, r = l.end;
				return i.isAfter(t) && i.isBefore(n) || r.isAfter(t) && r.isBefore(n) || i.isBefore(t) && r.isAfter(n) || i.isSame(t) || r.isSame(n)
			}
			...
			function c(e, t, n) {
				var l = a(e).startOf(t), i = a(e).endOf(t);
				return o(n, l, i)
			}
			...
			function m() {
				for (var e = [], t = 0; 7 > t;)e.push(i(a().weekday(t++), l.dateFormats.weekDay));
				return e
			}

			function u(e, t, n) {
				for (var r = [], d = c(t, "year", e), s = a(t).startOf("year"), m = 0; 12 > m;) {
					var u = s.clone(), f = u.clone().endOf("month"), p = o(d, u, f), w = {
						label: i(u, l.dateFormats.month),
						isToday: u.isSame(a().startOf("month")),
						events: p,
						date: u,
						badgeTotal: v(p)
					};
					n({calendarCell: w}), r.push(w), s.add(1, "month"), m++
				}
				return r
			}

			function f(e, t, n) {
				var i, r = a(t).startOf("month"), d = r.clone().startOf("week"), s = a(t).endOf("month").endOf("week");
				i = l.displayAllMonthEvents ? o(e, d, s) : o(e, r, r.clone().endOf("month"));
				for (var c = [], m = a().startOf("day"); d.isBefore(s);) {
					var u = d.month() === a(t).month(), f = [];
					(u || l.displayAllMonthEvents) && (f = o(i, d, d.clone().endOf("day")));
					var p = {
						label: d.date(),
						date: d.clone(),
						inMonth: u,
			...
			function p(e, t) {
				for (var n = a(t).startOf("week"), r = a(t).endOf("week"), s = n.clone(), c = [], v = a().startOf("day"); c.length < 7;)c.push({
					weekDayLabel: i(s, l.dateFormats.weekDay),
					date: s.clone(),
					dayLabel: i(s, l.dateFormats.day),
					isPast: s.isBefore(v),
					isToday: s.isSame(v),
					isFuture: s.isAfter(v),
					isWeekend: [0, 6].indexOf(s.day()) > -1
				}), s.add(1, "day");
				var m = o(e, n, r).map(function (e) {
					var t, l = a(n).startOf("day"), i = a(r).startOf("day"), s = d({
						start: a(e.startsAt).startOf("day"),
						end: a(e.endsAt || e.startsAt).startOf("day")
					}, e.recursOn, l), o = s.start, c = s.end;
					return t = o.isBefore(l) || o.isSame(l) ? 0 : o.diff(l, "days"), c.isAfter(i) && (c = i), o.isBefore(l) && (o = l), e.daySpan = a(c).diff(o, "days") + 1, e.dayOffset = t, e
				});
				return {days: c, events: m}
			}

			function w(e, t, n, l, i) {
				var r = a(n || "00:00", "HH:mm").hours(), d = a(l || "23:00", "HH:mm").hours(), c = 60 / i * 30, v = a(t).startOf("day").add(r, "hours"), m = a(t).startOf("day").add(d + 1, "hours"), u = (d - r + 1) * c, f = c / 60, p = [], w = o(e, a(t).startOf("day").toDate(), a(t).endOf("day").toDate());
				return w.map(function (e) {
					...
					return p.forEach(function (n, a) {
						...
						n.filter(function (e) {
							...
							(s(e, t.startsAt, t.endsAt || t.startsAt) || s(t, e.startsAt, e.endsAt || e.startsAt)) && (l = !1)
						}), l && t && (t = !1, e.left = 150 * a, p[a].push(e))
			...
			function h(e, t, n, l, i) {
				...
				return r.days.forEach(function (e) {
					var t = r.events.filter(function (t) {
			...
			function g(e, t, n) {
				var l = a(e || "00:00", "HH:mm"), i = a(t || "23:00", "HH:mm"), r = 60 / n * 30;
				return (i.diff(l, "hours") + 1) * r + 2
			}

			function y() {
				var n = Object.keys(l.templates).map(function (e) {
					var n = l.templates[e];
					return t(n)
				});
				return e.all(n)
		...
		a.module("mwl.calendar").factory("calendarTitle", ["moment", "calendarConfig", "calendarHelper", function (e, t, n) {
			...
			return {day: a, week: l, month: i, year: r}
		}])
	}, function (e, t, n) {
		"use strict";
		var a, l = n(1);
		...
		"use strict";
		var a = n(1), l = n(39);
		a.module("mwl.calendar").constant("moment", l)
	}, function (e, t, n) {
		function a(e) {
			return n(l(e))
		}
		...
		var i = {
			...
			"./mwlDraggable.js": 22,
			"./mwlDroppable.js": 23,
			"./mwlElementDimensions.js": 24,
			"./mwlResizable.js": 25
		};
		a.keys = function () {
			return Object.keys(i)
		}, a.resolve = l, e.exports = a, a.id = 35
	}, function (e, t, n) {
		function a(e) {
			return n(l(e))
		}
		...
		var i = {
			"./calendarDate.js": 26,
			"./calendarLimitTo.js": 27,
			"./calendarTruncateEventTitle.js": 28,
			"./calendarTrustAsHtml.js": 29
		};
		a.keys = function () {
			return Object.keys(i)
		}, a.resolve = l, e.exports = a, a.id = 36
	}, function (e, t, n) {
		function a(e) {
			return n(l(e))
		}
		...
		var i = {
			"./calendarConfig.js": 30,
			"./calendarHelper.js": 31,
			"./calendarTitle.js": 32,
			"./interact.js": 33,
			"./moment.js": 34
		};
		a.keys = function () {
			return Object.keys(i)
		}, a.resolve = l, e.exports = a, a.id = 37
	}, function (e, t, n) {
		function a(e) {
			return n(l(e))
		}
