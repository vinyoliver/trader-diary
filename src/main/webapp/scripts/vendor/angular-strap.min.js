	...
	angular.module('mgcrea.ngStrap.typeahead', ['mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions']).provider('$typeahead', function () {
		...
		return {
			restrict: 'EAC', scope: !0, compile: function (e, t) {
				var o = {};
				if (!t.bsDropdown) {
					for (var i = e[0].nextSibling; i && 1 !== i.nodeType;)i = i.nextSibling;
					i.classList.contains('dropdown-menu') && (o.template = i.outerHTML, o.templateUrl = n, i.parentNode.removeChild(i))
				}
				return function (e, n, i) {
					o.scope = e, angular.forEach(['template', 'templateUrl', 'controller', 'controllerAs', 'placement', 'container', 'delay', 'trigger', 'keyboard', 'html', 'animation', 'id'], function (e) {
						angular.isDefined(t[e]) && (o[e] = t[e])
					});
					var r = /^(false|0|)$/i;
					angular.forEach(['html', 'container'], function (e) {
						angular.isDefined(i[e]) && r.test(i[e]) && (o[e] = !1)
					}), i.bsDropdown && e.$watch(i.bsDropdown, function (t, n) {
						e.content = t
					}, !0), i.bsShow && e.$watch(i.bsShow, function (e, t) {
